...
public class TelaAtualizaLivroController {
	...
	public static void populaTabelaLivros(DefaultTableModel dtmLivros) {
		...
		for(Livro liv : Colecao.getLivrosTemporario()) { //percorre a cole̤̣o e para cada autor cria um objeto e adiciona na tabela geral
	...
	public class selecionaAutor implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			...
			} else {// se ṇo foi escolhido a outra tabela e esse else acontece
				Object[] data = new Object[3];
